# deebweb#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Nazmul Tufan
...
\033[1;93m███▓▒░░._\033[1;97mNAZMUL\033[1;93m_.░░▒▓███►
...
\033[1;91mAuthor©\033[1;91m: \033[1;93mNazmul Tufan


\033[1;91mFacebook\033[1;91m: \033[1;93mhttps://www.facebook.com/access.darkweb.hacker
\033[1;91m«--------------------\033[1;93m✧\033[1;91m--------------------»"""
jalan("\033[1;97m Please Don't Clone Bangladeshi Facebook Idz   ")
jalan('\033[1;97m Username Nazmul Password Tufan   ')
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Nazmul
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Nazmul_Tufan.
	print logo
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;97m«--------------------\033[1;92m✧\033[1;97m--------------------»"
	print "  \033[1;91m«---------Developed By Nazmul------------»" #Dev:Nazmul_Tufan.
             ...
             ( (  \.---./  ) )
              '.__/o   o\__.'
                 {=  ^  =}
                  >  -  <
.-------------.""`-------`"".-------------.
: \033[1;92m     HACKERS KING OF Nazmul..    \033[1;93m :
'-----------------------------------------' 
                ___)( )(___
               (((__) (__)))"""
